...
import LandingGraph from "./LandingGraph.jsx"
...
const BTN_PRIMARY =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-primary-container text-white font-semibold shadow-md shadow-primary/25 transition-all hover:bg-primary cursor-pointer"
const BTN_SECONDARY =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-surface-container-lowest text-on-surface font-medium border border-outline-variant/60 shadow-sm transition-all hover:bg-surface-container cursor-pointer"

function LandingSiteNav() {
  const navigate = useNavigate()

  return (
    <>
      <aside className="w-full bg-slate-900 text-slate-400 py-1.5 px-4 border-b border-slate-800 text-center flex items-center justify-center overflow-hidden">
        <p className="text-xs font-mono flex items-center justify-center gap-2 whitespace-nowrap">
          <span className="inline-block w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
          <span className="font-semibold text-white tracking-wider">STATUTORY DEFENSE SYSTEM ACTIVE</span>
          <span className="text-slate-400">|</span>
          <span className="hidden lg:inline">Demo environment · simulated financial telemetry · explainable AI ready for FIU reporting</span>
        </p>
      </aside>
      ...
      <header className="w-full sticky top-0 z-50 bg-surface/95 backdrop-blur-md px-6 py-3 border-b border-surface-container-highest transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-6">
            <a href="/" className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-mono tracking-widest text-primary font-bold mt-0.5">FORENSIC CORE</span>
              </div>
            </a>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              className={`${BTN_PRIMARY} px-3.5 py-1.5 text-xs`}
              type="button"
              onClick={() => navigate("/login")}
            >
    ...
    <div className="min-h-screen w-full overflow-x-clip bg-surface text-on-surface antialiased font-sans">
      ...
      <section className="relative w-full overflow-hidden pt-10 pb-14 px-6 bg-gradient-to-b from-surface via-surface to-surface-container-low border-b border-surface-container-high">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 flex flex-col items-start gap-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary-container/70 border border-primary/20 text-on-surface rounded-full text-xs font-mono font-semibold">
            ...
            <p className="text-secondary leading-relaxed max-w-xl text-base">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button className={`${BTN_PRIMARY} px-5 py-2.5 text-sm`} onClick={scrollToDemo} type="button">
                <span>Explore Demo</span>
                <MaterialIcon name="arrow_forward" className="text-base" />
              </button>
              <a className={`${BTN_SECONDARY} px-5 py-2.5 text-sm`} href="#network-explorer-preview">
                <MaterialIcon name="scatter_plot" className="text-base text-primary" />
              ...
              <button
                ...
                type="button"
              >
                <MaterialIcon name="keyboard_command_key" className="text-base text-primary" />
                <span>Navigator</span>
                <kbd className="px-1.5 py-0.5 rounded bg-surface-container-high font-mono text-xs">⌘K</kbd>
              </button>
            </div>
            <div className="flex flex-wrap items-center gap-y-2 gap-x-5 pt-3 text-secondary border-t border-surface-container-highest w-full mt-2">
              ...
              <div className="flex items-center gap-1.5 text-xs">
                <MaterialIcon name="security" className="text-base text-primary" />
            ...
            <div className="relative bg-slate-950 text-slate-200 rounded-xl shadow-2xl border border-slate-800 overflow-hidden ring-1 ring-white/10">
              <div className="flex items-center justify-between px-3.5 py-2.5 bg-slate-900 border-b border-slate-800">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="ml-2 font-mono text-xs text-slate-400 select-none whitespace-nowrap flex-1">flowsight-engine-v4.2 — pid 84192</span>
                </div>
                <div className="hidden sm:flex items-center gap-1.5 bg-red-950/80 border border-red-800/80 px-2 py-0.5 rounded text-xs font-mono text-red-400 flex-shrink-0">
                  <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-ping"></span>
                  <span>LIVE TELEMETRY TRACE — 14.2ms / hop</span>
                </div>
              </div>
              <div className="p-4 font-mono text-body-md leading-relaxed relative overflow-hidden bg-slate-950/95 space-y-1.5">
                ...
                <div className="pt-1 text-amber-400 font-semibold flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-2 pt-1 text-xs">
                  <div className="bg-slate-900/60 p-1.5 rounded border border-slate-800/80">
                    ...
                    <span className="text-emerald-400 text-xs ml-1">(98.4% conf)</span>
                  </div>
                  <div className="bg-slate-900/60 p-1.5 rounded border border-slate-800/80">
              ...
              <div className="p-3 bg-slate-900/80 border-t border-slate-800">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-mono tracking-widest text-slate-400 uppercase">Live Topology Graph • Cluster #42</span>
      ...
      <section className="w-full bg-slate-900 border-b border-slate-800 text-white py-4 px-6 shadow-inner">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="flex flex-col border-l-2 border-primary pl-3">
            <span className="text-xs font-mono text-slate-400 tracking-wider uppercase">Transactions Scanned Today</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              ...
              <span className="inline-flex items-center text-xs font-mono text-emerald-400 bg-emerald-950/80 px-1.5 py-0.5 rounded border border-emerald-800">
          ...
          <div className="flex flex-col border-l-2 border-amber-500 pl-3">
            <span className="text-xs font-mono text-slate-400 tracking-wider uppercase">Suspicious Networks Found</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              <span className="text-xl sm:text-2xl font-bold font-mono text-amber-400">
                <AnimatedNumber duration={700} value={34} />
              </span>
              <span className="text-xs font-mono text-amber-400 bg-amber-950/80 px-1.5 py-0.5 rounded border border-amber-800">4 Active Today</span>
            </div>
          </div>
          <div className="flex flex-col border-l-2 border-red-500 pl-3">
            <span className="text-xs font-mono text-slate-400 tracking-wider uppercase">₹ Flagged This Week</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              ...
              <span className="text-xs font-mono text-slate-400 bg-slate-800 px-1.5 py-0.5 rounded">98.4% Precision</span>
            </div>
          </div>
          <div className="flex flex-col border-l-2 border-blue-500 pl-3">
            <span className="text-xs font-mono text-slate-400 tracking-wider uppercase">Mean Detection Latency</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              ...
              <span className="text-xs font-mono text-blue-400 bg-blue-950/80 px-1.5 py-0.5 rounded border border-blue-800">Instant Traversal</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-surface-container-lowest border-b border-surface-container-highest overflow-hidden" aria-label="Live incident feed">
        <div className="max-w-7xl mx-auto flex items-center">
          <div className="flex items-center gap-2 px-4 py-2.5 bg-error text-white font-mono text-xs font-bold tracking-widest uppercase flex-shrink-0">
          ...
          <div className="relative flex-1 overflow-hidden" style={{ maskImage: "linear-gradient(90deg, transparent 0, black 40px, black calc(100% - 40px), transparent 100%)" }}>
            <div className="flex w-max animate-marquee gap-space-lg py-2.5 pl-space-lg">
              {[...feed, ...feed].map((item, i) => {
                ...
                return (
                  <span key={`${item.id}-${i}`} className={`flex items-center gap-2 border-l-2 pl-3 pr-1 ${tone.border} font-mono text-xs text-on-surface-variant whitespace-nowrap`}>
      ...
      <section className="w-full py-3.5 bg-surface-container px-6 border-b border-surface-container-highest">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 text-secondary">
          <span className="font-mono text-xs font-semibold tracking-wider text-secondary uppercase">TRUSTED BY AML &amp; FIU TEAMS AT</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex flex-col justify-between">
              ...
              <div className="mt-6 pt-4 border-t border-surface-container-high flex items-center justify-between font-mono text-xs">
                <span className="text-secondary font-semibold uppercase">Mule Cluster Recognition</span>
                <span className="px-2 py-0.5 rounded bg-primary/10 text-primary font-bold">Active · 14 Hops</span>
              </div>
            </div>
            <div className="group bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex flex-col justify-between">
              <div className="flex flex-col gap-4">
              ...
              <div className="mt-6 pt-4 border-t border-surface-container-high flex items-center justify-between font-mono text-xs">
                <span className="text-secondary font-semibold uppercase">Cadence Sampling</span>
                <span className="px-2 py-0.5 rounded bg-primary/10 text-primary font-bold">T+0 to T+90 Replay</span>
              </div>
            </div>
            <div className="group bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/50 shadow-sm hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex flex-col justify-between">
              <div className="flex flex-col gap-4">
              ...
              <div className="mt-6 pt-4 border-t border-surface-container-high flex items-center justify-between font-mono text-xs">
                <span className="text-secondary font-semibold uppercase">SAR/STR Export</span>
                <span className="px-2 py-0.5 rounded bg-primary/10 text-primary font-bold">FIU XML / PDF Ready</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-7 w-full bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/60 shadow-xl">
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-surface-container-highest">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-xs font-mono bg-primary/10 text-primary font-bold flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary animate-ping"></span> NEW · 2s ago
                </span>
              </div>
              <span className="px-2.5 py-0.5 rounded text-xs font-semibold bg-red-950 text-red-400 border border-red-800">Critical Alert</span>
            </div>
            <div className="bg-slate-900 text-slate-200 p-4 rounded-lg font-mono text-xs space-y-2.5 border border-slate-800">
              ...
              <div className="bg-slate-950 p-2.5 rounded border border-slate-800 text-slate-400 flex items-start justify-between gap-2">
                ...
                <span className="px-1.5 py-0.5 bg-amber-950 text-amber-400 border border-amber-800 rounded text-xs sm:whitespace-nowrap">Flag: Off-hours Velocity</span>
              </div>
              <div className="bg-slate-950 p-2.5 rounded border border-red-800/80 text-slate-400 flex items-start justify-between gap-2 bg-red-950/20">
                <div>
                ...
                <span className="px-1.5 py-0.5 bg-red-950 text-red-400 border border-red-800 rounded text-xs sm:whitespace-nowrap animate-pulse font-semibold">Flag: Smurfing Pattern [JUST FLAGGED]</span>
              </div>
              <div className="pt-2 border-t border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between text-xs text-slate-400 gap-1">
                <span className="text-emerald-400 font-bold">CONFIDENCE SCORE: 98.4%</span>
                <span className="text-slate-400 font-mono">EVIDENCE PACK SHA-256: 8f4e21a9...c4b2 VERIFIED BY FIU ADAPTER</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-xl mx-auto">
          <div className="bg-surface-container-lowest rounded-2xl shadow-2xl border border-outline-variant/60 p-6 sm:p-8 flex flex-col gap-6">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleLogin}>
              ...
              <button className={`w-full py-2.5 ${BTN_PRIMARY} text-sm`} type="submit">
                Sign In to Forensic Console
              </button>
            </form>
            <div className="relative flex items-center justify-center my-1">
              <div className="w-full bg-surface-container-highest h-[1px]"></div>
              <span className="absolute bg-surface-container-lowest px-3 font-mono text-xs text-secondary font-medium uppercase">OR TRY A QUICK DEMO</span>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button className="px-3.5 py-2.5 bg-surface-container-low/50 hover:bg-surface-container-low text-left rounded-lg transition-all border border-outline-variant/30 hover:border-outline-variant/60 flex items-start justify-between gap-2 group cursor-pointer" onClick={() => navigate("/analyst/overview")} type="button">
                <span className="flex flex-col">
                  <span className="text-sm font-semibold text-on-surface-variant">Analyst Demo</span>
                  <span className="text-xs text-secondary mt-0.5">A. Sharma (L2 FIU Officer)</span>
                </span>
                <MaterialIcon name="badge" className="text-base text-on-surface-variant group-hover:text-primary transition-colors" />
              </button>
              <button className="px-3.5 py-2.5 bg-surface-container-low/50 hover:bg-surface-container-low text-left rounded-lg transition-all border border-outline-variant/30 hover:border-outline-variant/60 flex items-start justify-between gap-2 group cursor-pointer" onClick={() => navigate("/admin/overview")} type="button">
                <span className="flex flex-col">
                  <span className="text-sm font-semibold text-on-surface-variant">Admin Demo</span>
                  <span className="text-xs text-secondary mt-0.5">Risk Director Sandbox</span>
                </span>
                <MaterialIcon name="admin_panel_settings" className="text-base text-on-surface-variant group-hover:text-primary transition-colors" />
              </button>
            </div>
          </div>
        </div>
